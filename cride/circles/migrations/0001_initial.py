# Generated by Django 2.2.10 on 2020-07-26 04:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('about', models.CharField(max_length=225, verbose_name='circle name')),
                ('picture', models.ImageField(blank=True, null=True, upload_to='circles/pictures')),
                ('rides_offered', models.PositiveIntegerField(default=0)),
                ('rides_taken', models.PositiveIntegerField(default=0)),
                ('verified', models.BooleanField(default=False, help_text='Verified cicles are also known as official communities', verbose_name='verified circle')),
                ('is_public', models.BooleanField(default=True, help_text=' Public cicles are listed in the main page so everyone know about there existence')),
                ...
                ('members_limit', models.PositiveIntegerField(default=0, help_text='If a circle is limited, this will be the limit on the number of the members')),
            ],
            options={
